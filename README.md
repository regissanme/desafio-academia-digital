...
<p> Desafio de projeto <strong>Conhecendo o Projeto Spring Data JPA na Prática</strong> oferecido gratuitamente pela plataforma de cursos online <a href="https://dio.me/"><strong> Digital Innovation One</strong></a>.<br>

## 15/08/2022 - Desafio de Projeto do Bootcamp Spring Framework Experience
...
- LinkedIn:  [cami-la](https://www.linkedin.com/in/cami-la/ "cami-la").
- [GitHub do Projeto Original](https://github.com/cami-la/academia-digital).

<h3>Desafio:</h3> 
<p>Possibilitar ao Dev conhecer os principais conceitos de mapeamento objeto relacional (ORM) usando o <strong>Spring Data JPA</strong>. Para isso, uma <strong>API RESTful</strong> será desenvolvida com ênfase na modelagem de suas entidades, no domínio de uma academia de ginástica.</p>
